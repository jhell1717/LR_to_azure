...
def main():
    ...
    sk_pipeline = joblib.load("/Users/joshuahellewell/Desktop/01-dev/ml_deploy/src/models/model.joblib")
    sk_probs = sk_pipeline.predict_proba(X_sample)[:,1]

    sess = rt.InferenceSession("/Users/joshuahellewell/Desktop/01-dev/ml_deploy/src/models/model.onnx")
